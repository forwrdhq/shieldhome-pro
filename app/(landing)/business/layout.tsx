...
const businessSchema = {
  ...
  description:
    'Smart Home Security Specialists providing commercial and business security systems with no commercial markup. AI cameras, smart locks, 8-second monitoring response.',
