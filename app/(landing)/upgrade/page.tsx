...
function UpgradeContent() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Form */}
      <section id="upgrade-form" className="py-12 bg-[#F8F9FA]">
      ...
      <section className="py-14 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#1A1A2E] mb-2">Current Offers</h2>
            <p className="text-gray-600">Exclusive savings for Vivint customers</p>
          </div>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-[#F8F9FA] rounded-2xl p-6 border border-gray-200 relative">
              <div className="absolute -top-3 right-4 bg-[#00C853] text-white text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1">
                <Tag size={12} /> Save $299
              </div>
              <h3 className="text-xl font-bold text-[#1A1A2E] mb-3">Buy 2 Cameras, Get 1 Free</h3>
            ...
            <div className="bg-[#F8F9FA] rounded-2xl p-6 border border-gray-200 relative">
              ...
              <h3 className="text-xl font-bold text-[#1A1A2E] mb-3">Up to $500 Off Equipment</h3>
              <p className="text-gray-600 text-sm mb-4">
      ...
      <section className="py-14 bg-[#F8F9FA]">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-[#1A1A2E] mb-2">What&apos;s New</h2>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {equipment.map((item) => (
              <div key={item.name} className="bg-white rounded-xl border border-gray-200 p-5 flex flex-col">
                <div className="w-16 h-16 bg-gray-100 rounded-xl flex items-center justify-center mx-auto mb-3 text-[#1A1A2E]">
                  {item.icon}
                </div>
                <h3 className="font-bold text-[#1A1A2E] text-sm text-center mb-3">{item.name}</h3>
                <ul className="space-y-1.5 flex-1">
                  {item.features.map((f) => (
                    <li key={f} className="flex items-start gap-1.5 text-xs text-gray-600">
                      <CheckCircle size={12} className="text-[#00C853] flex-shrink-0 mt-0.5" />
                      {f}
                    </li>
                  ))}
                </ul>
                <p className="mt-3 pt-3 border-t border-gray-100 text-[10px] text-[#00C853] font-semibold">
                  {item.upgrade}
                </p>
              </div>
            ))}
      ...
      <section className="py-12 bg-white">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-green-100 rounded-full mb-4">
            <Wrench className="text-[#00C853]" size={28} />
          </div>
          <h2 className="text-2xl font-extrabold text-[#1A1A2E] mb-3">Professional Installation Included</h2>
