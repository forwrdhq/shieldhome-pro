...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Authorized Vivint Dealer pricing. Free professional installation. Most homes protected within 48 hours. See if you qualify in 60 seconds.',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'The Smartest Home Security in America — Now $0 Down',
    description: 'Authorized Vivint Dealer pricing. Free pro install. Protected in 48 hours.',
  },
  alternates: {
