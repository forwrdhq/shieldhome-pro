...
export const metadata: Metadata = {
  ...
  description: 'Find home security systems and free installation in your area. Get local crime data and a free custom security quote from a smart home security specialists.',
  alternates: {
