...
const headlineMap: Record<string, string> = {
  ...
  'vivint-dealer': 'Vivint Smart Home Partner — Free Installation + $0 Down',
  'vivint-near-me': 'Vivint Smart Home Partner — Free Installation + $0 Down',
  'vivint': 'Vivint Smart Home Partner — Free Installation + $0 Down',
...
export default async function GooglePage({ searchParams }: PageProps) {
  ...
  const preHeadline = city
    ...
    : 'Exclusive Deals From a Top Vivint Smart Home Partner'
