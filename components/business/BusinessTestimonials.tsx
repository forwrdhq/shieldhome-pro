...
const testimonials: Testimonial[] = [
  ...
  },
  {
    initials: 'JR',
    name: 'Jason R.',
    business: '6 locations',
    location: 'Austin, TX',
    date: 'Dec 2024',
    headline: 'Tenant access code changes now take 30 seconds. Used to cost $800/month in locksmith fees.',
    headlineIcon: '🔑',
          ...
          {testimonials.map((t) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3">
                <div
                  className="w-10 h-10 rounded-full flex items-center justify-center text-[13px] font-heading font-bold text-white"
                ...
                <div>
                  <p className="text-[13px] font-heading font-semibold text-white">
                    {t.name} — <span className="text-slate-400 font-normal">Owner, {t.business}</span>
                  </p>
              ...
              {/* Dollar Headline */}
              <p className="text-[13px] md:text-[14px] font-heading font-bold text-emerald-400 mt-3 mb-3">
                {t.headlineIcon} {t.headline}
              </p>

              {/* Story Body */}
              <p className="text-[13px] font-body text-slate-400 leading-relaxed" style={{ textIndent: '-0.35em' }}>
                &ldquo;{t.body}&rdquo;
              </p>
            </div>
          ))}
