...
const faqs = [
  // Cost-specific questions first
  {
    q: 'How much does home security cost per month?',
    a: "Professional home security monitoring typically costs $25–$60/month depending on your system and provider. Through ShieldHome, plans start at $24.99/month and include 24/7 professional monitoring, the mobile app, and smart home controls. Most families pay $35–$55/month total.",
  },
  {
    q: 'Is there a cheaper alternative to ADT?',
    a: "Yes. ADT's monitoring starts at $24.99/month but requires a $99–$199 installation fee and often a 36-month contract. Through ShieldHome, you get Vivint's #1-rated system with free professional installation, $0 down, and flexible terms — often saving $500–$1,000 in the first year compared to ADT.",
  },
  // Standard questions
  {
      ...
      <div className="max-w-3xl mx-auto px-5 md:px-8">
        <div className="text-center mb-8 md:mb-14">
          ...
          <h2 className="font-heading font-bold text-[22px] md:text-[38px] tracking-[-0.03em] text-slate-900">
            Common Questions About Home Security Costs
          </h2>
        </div>
