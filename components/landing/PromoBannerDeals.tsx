      ...
      <div className="hidden md:flex items-center justify-between max-w-7xl mx-auto px-6 py-3">
        ...
        <div className="flex-1 flex flex-col items-center gap-1.5 px-4">
          <div className="text-[14px] text-center">
            <span className="font-bold text-emerald-400">Spring Promotions Now Live — </span>
            <span className="text-white">Up to $2,847 in Savings &middot; $0 Down*</span>
          </div>
          <p className="text-[11px] text-slate-500">
            *Qualifying purchase required &middot; Limited April install slots
          </p>
      ...
      <div className="md:hidden relative px-4 py-3">
        ...
        <div className="flex flex-col items-center gap-2 pr-5">
          <div className="text-[12px] text-center leading-tight">
            <span className="font-bold text-emerald-400">Up to $2,847 in Savings &middot; $0 Down*</span>
          </div>
          <p className="text-[10px] text-slate-500 text-center">
            *Qualifying purchase &middot; Limited install slots
          </p>
